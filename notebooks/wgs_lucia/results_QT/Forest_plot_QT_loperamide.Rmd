...
file1 <- "loperamide/burden_test/phenos.QT.step2_total_exposure_counts.regenie"
file2 <- "loperamide/burden_test/phenos.QT.step2_total_duration.regenie"
file3 <- "loperamide/burden_test/phenos.QT.step2_num_drug_era_id.regenie"
file4 <- "loperamide/burden_test/phenos.QT.step2_cumulative_gap_days.regenie"
file5 <- "loperamide/burden_test/phenos.QT.step2_adherence_score_omop.regenie"
...
id_order <- c("OPRM1.No_efficacy.0.01", "OPRM1.Low_efficacy.0.01", "OPRM1.No_Low_efficacy.0.01", "OPRM1.No_Low_efficacy_High_Impact_Variants.0.01","OPRM1.No_Low_efficacy_High_Moderate_Impact_Variants.0.01")
...
forest_plot <- ggplot(combined_df, aes(x = BETA, y = ID)) +
  ...
  labs(
    title = "Forest Plot of Beta with Error Bars Qt Phenotypes Loperamide",
    x = "Beta (Effect Size)",
    y = "Mask"
  ) +
